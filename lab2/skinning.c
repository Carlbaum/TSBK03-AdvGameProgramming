...
float weight21[kMaxRow] = {1.0, 1.0, 1.0, 0.9, 0.5, 0.5, 0.1, 0.0, 0.0, 0.0};
float weight22[kMaxRow] = {0.0, 0.0, 0.0, 0.1, 0.5, 0.5, 0.9, 1.0, 1.0, 1.0};
...
//TODO:
      ...
      // float test = 1.2f;
      // printf("test1 = %f\n", test);
      printf("bone0, pos = (%f,%f,%f)\nbone1, pos = (%f,%f,%f)\n\n", g_bones[0].pos.x,g_bones[0].pos.y,g_bones[0].pos.z,g_bones[1].pos.x,g_bones[1].pos.y,g_bones[1].pos.z);
      // printf("bone1, rot = \n(%f,%f,%f,%f)\n", g_bones[1].rot.m[0],g_bones[1].rot.m[1],g_bones[1].rot.m[2],g_bones[1].rot.m[3]);
      // printf("(%f,%f,%f,%f)\n", g_bones[1].rot.m[4],g_bones[1].rot.m[5],g_bones[1].rot.m[6],g_bones[1].rot.m[7]);
      // printf("(%f,%f,%f,%f)\n", g_bones[1].rot.m[8], g_bones[1].rot.m[9], g_bones[1].rot.m[10],g_bones[1].rot.m[11]);
      // printf("(%f,%f,%f,%f)\n", g_bones[1].rot.m[12],g_bones[1].rot.m[13],g_bones[1].rot.m[14],g_bones[1].rot.m[15]);
      // mat4 tM = T(1.2f,2.3f,3.4f);
      // printf("test T, rot = \n(%f,%f,%f,%f)\n", tM.m[0],tM.m[1],tM.m[2],tM.m[3]);
      // printf("(%f,%f,%f,%f)\n", tM.m[4],tM.m[5],tM.m[6],tM.m[7]);
      // printf("(%f,%f,%f,%f)\n", tM.m[8], tM.m[9], tM.m[10],tM.m[11]);
      // printf("(%f,%f,%f,%f)\n", tM.m[12],tM.m[13],tM.m[14],tM.m[15]);

      // for(int r = 0; r < kMaxRow; r++) {
      //   for(int c = 0; r < kMaxCorners; c++) {
      // if( weight[row] ) {
      //   g_vertsRes[row][corner] = ScalarMult(
      //                               MultVec3(
      //                                 Mult(
      //                                   T(g_bones[1].pos.x,
      //                                     g_bones[1].pos.y,
